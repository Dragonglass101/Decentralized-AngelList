    ...
    return (
        <>
            ...
            <div class="p-5 mb-4 mx-5 background-light-purple rounded-3 d-flex">
                <div class="container-fluid py-4" style={{width:'60%'}}>
                ...
                <div class="container-fluid py-5" style={{width:'40%'}}>
                    {/* <h1 class="display-5 fw-bold">Invest in world-changing startups</h1>
                    <p class="col-md-8 fs-4 p-0">Join leading investors funding the next wave of world-changing startups.</p>
                    <button class="btn btn-primary btn-lg" type="button">Invest Now</button> */}
                </div>
            </div>
        </>
    )
