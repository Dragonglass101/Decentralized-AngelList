        ...
        <>
            <div style={{ width: '30%', height: '100%' }}>
                <div className='shadow-sm h-100'>
                    ...
                    <div className="list-group" style={{ overflow: 'auto', height: '510px' }}>
            ...
            <div className='ms-1' style={{ width: '70%' }}>
                <div className='container bg-white w-100 p-0 rounded'>
                    ...
                    <div className='container p-0 py-5' style={{ overflow: 'auto', height: '50vh' }}>
