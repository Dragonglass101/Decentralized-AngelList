...
const InvestorNavbar = () => {
        ...
        useEffect(() => {
            ...
            const getProfile = async() => {
                ...
                setname(investorJSON.name);
                setphotoCID(investorJSON.photoCID);
            }
            if (wallet && !balance) {
                retrieveBalance();
                getProfile();
        ...
        return ( <
            ...
            style = {
                { backgroundColor: 'rgb(18,24,39)', color: 'rgb(26,27,47)' } }
            variant = "persistent"
            classes = {
                {
            ...
            style = {
                ...
                div className = "d-flex py-3 ps-4 my-2"
                style = {
                        { borderRadius: '5px', backgroundColor: 'rgb(25, 33, 48)' } } >
                    <
                    div style = {
                        { width: '50%' } } >
                    <
                ...
                style = {
                    { color: 'grey', backgroundColor: 'grey', marginBottom: 'auto' } }
                /> <
                h6 className = "font10 ps-2 mt-4" > GENERAL < /h6> <
                    Link to = "/dashboard-investor"
                style = {
                        { color: "inherit", textDecoration: 'unset' } } >
                    <
                    ListItem
                className = {
                    (currentLocation === "/dashboard-investor" ? "highlight-karo" : "") }
                style = {
                    { marginBottom: '10px' } }
                button key = 'Dashboard' >
                    <
                    HomeRoundedIcon className = {
                        (currentLocation === "/dashboard-investor" ? "green-karo" : "") + " menu-icon-color" }
                /> { /* <ListItemText className="ms-2" primary='Dashboard'/> */ } <
                span className = {
                        (currentLocation === "/dashboard-investor" ? "green-karo" : "") + " font13 fw-bold ms-2 menu-item-color" } > Dashboard < /span> <
                    /ListItem> <
                    /Link>

                <
                Link to = "/investment-request"
                style = {
                        { color: "inherit", textDecoration: 'unset' } } >
                    <
                    ListItem
                className = {
                    (currentLocation === "/investment-request" ? "highlight-karo" : "") }
                style = {
                    { marginBottom: '10px' } }
                button key = 'Track Investments' >
                    <
                    ReceiptRoundedIcon className = {
                        (currentLocation === "/investment-request" ? "green-karo" : "") + " menu-icon-color" }
                /> { /* <ListItemText className="ms-2" primary='Dashboard'/> */ } <
                span className = {
                        (currentLocation === "/investment-request" ? "green-karo" : "") + " font13 fw-bold ms-2 menu-item-color" } > Track Investments < /span> <
                    /ListItem> <
                    /Link>

                <
                Link to = "/chatroom-investor"
                style = {
                        { color: "inherit", textDecoration: 'unset' } } >
                    <
                    ListItem
                className = {
                    (currentLocation === "/chatroom-investor" ? "highlight-karo" : "") }
                style = {
                    { marginBottom: '10px' } }
                button key = 'Chat Room' >
                    <
                    ForumRoundedIcon className = {
                        (currentLocation === "/chatroom-investor" ? "green-karo" : "") + " menu-icon-color" }
                /> { /* <ListItemText className="ms-2" primary='Dashboard'/> */ } <
                span className = {
                        (currentLocation === "/chatroom-investor" ? "green-karo" : "") + " font13 fw-bold ms-2 menu-item-color" } > Chat Room < /span> <
                    /ListItem> <
                    /Link>

                <
                Link to = "/startups-list-investor"
                style = {
                        { color: "inherit", textDecoration: 'unset' } } >
                    <
                    ListItem
                className = {
                    (currentLocation === "/startups-list-investor" ? "highlight-karo" : "") }
                style = {
                    { marginBottom: '10px' } }
                button key = 'Startups List' >
                    <
                    ListAltRoundedIcon className = {
                        (currentLocation === "/startups-list-investor" ? "green-karo" : "") + " menu-icon-color" }
                /> { /* <ListItemText className="ms-2" primary='Dashboard'/> */ } <
                span className = {
                        (currentLocation === "/startups-list-investor" ? "green-karo" : "") + " font13 fw-bold ms-2 menu-item-color" } > Startups List < /span> <
                    /ListItem> <
                    /Link>
                ...
                style = {
                    ...
                    ListItem
                className = {
                    (currentLocation === "/profile-investor" ? "highlight-karo" : "") }
                style = {
                    { marginBottom: '10px' } }
                button key = 'Startups List' >
                    <
                    ListAltRoundedIcon className = {
                        (currentLocation === "/profile-investor" ? "green-karo" : "") + " menu-icon-color" }
                /> { /* <ListItemText className="ms-2" primary='Dashboard'/> */ } <
                span className = {
                        (currentLocation === "/profile-investor" ? "green-karo" : "") + " font13 fw-bold ms-2 menu-item-color" } > Profile < /span> <
                    /ListItem> <
                    /Link>
                ...
                div className = "mx-3 mb-5" >
                    ...
                    Button className = "mt-3 d-block w-100"
                variant = "outlined"
                color = "primary" >
                    Documentation <
                    /Button> <
