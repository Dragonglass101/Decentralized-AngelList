                    ...
                    <List className="mx-auto" style={{ width: '90%' }}>
                        ...
                        <div className="d-flex py-3 ps-4 my-2" style={{ borderRadius: '5px', backgroundColor: 'rgb(25, 33, 48)' }}>
                            ...
                            <div>
                                ...
                                <h6 className="font13 m-0"> 1300 ꜩ</h6>
                            </div>
                        </div>
                        ...
                        <Link to="/profile-investor" style={{ color: "inherit", textDecoration: 'unset' }}>
                            <ListItem
                                className={(currentLocation === "/profile-investor" ? "highlight-karo" : "")}
                                style={{ marginBottom: '10px' }} button key='Startups List'>
                                <ListAltRoundedIcon className={(currentLocation === "/profile-investor" ? "green-karo" : "") + " menu-icon-color"} />
                                {/* <ListItemText className="ms-2" primary='Dashboard'/> */}
                                <span className={(currentLocation === "/profile-investor" ? "green-karo" : "") + " font13 fw-bold ms-2 menu-item-color"}>Profile</span>
                            </ListItem>
                        </Link>
