                        ...
                        <Typography className={classes.instructions}>
                            <form onSubmit={handleSubmit}>
                                <div className={"container " + `${activeStep != 0 ? "hidden" : ""}`}>
                                    ...
                                    <p className='row font15 text-secondary'>Before we start, let's see if DevilsList Stack is a good fit for your company.</p>
                                    <Divider variant='fullWidth' />
                                    <h5 className='row font13 mt-3 ms-1 fw-bold'>I am</h5>
                                    <div className='row my-3 align-items-center'>
                                        <Switch color='primary' />
                                        <span className='col-11 fs-6 font13 text-secondary'>Starting a technology startup. DevilsList Stack is purpose-built for high growth technology companies.</span>
                                    </div>
                                    <div className='row my-3 align-items-center'>
                                        <Switch color='primary' />
                                        <span className='col-11 fs-6 font13 text-secondary'>Interested in raising capital from venture capitalists in the future. DevilsList Stack is confiqured to incorporate Delaware C Corporations, which are
                                            the preferred legal entity for businesses that aim to raise venture capital.</span>
                                    </div>
                                    <div className='row my-3 align-items-center'>
                                        <Switch color='primary' />
                                        <span className='col-11 fs-6 font13 text-secondary'>A resident of the United States. DevilsList Stack is currently only available to US residents with a Social Security Number or Taxpayer Identification
                                            Number.</span>
                                    </div>
                                </div>
                                ...
                                <div className={"container " + `${activeStep != 1 ? "hidden" : ""}`}>
                                    ...
                                    <form className='row mt-3 font13'>
                                        ...
                                        <div className='col-6'>
                                            <label for="basic-url" className="form-label font13 fw-bold">LinkedIn<span style={{ fontSize: '10px', height: 'fit-content' }}> (optional)</span></label>
                                            <div className="input-group mb-3">
                                                <span className="input-group-text font13" style={{ height: 'fit-content' }} id="basic-addon3">https://linkedin.com/in/</span>
                                                <input type="text" className="form-control font13" id="basic-url" aria-describedby="basic-addon3"
                                                    onChange={(e) =>
