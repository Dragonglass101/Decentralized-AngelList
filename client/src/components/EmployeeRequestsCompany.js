...
export const EmployeeRequestsCompany = () => {
                    ...
                    <div className={classes.padded}>
                        <div id='startup-list'>
                            <div className='row mx-3 align-items-center justify-content-between'>
                                <div className='col-4'>
                                    <h5 className='fw-bold m-0'>Recomended Companies</h5>
                                </div>
                                <div className="col-5 input-group shadow-sm h-100 p-0" style={{ overflow: 'hidden', borderColor: 'rgb(18, 24, 39)' }}>
                                    <input style={{ border: '0px' }} type="text" className="form-control bg-white" placeholder="Search Companies" aria-label="Recipient's username" aria-describedby="button-addon2" />
